...
import app.mycity.mycity.views.adapters.TopCheckinRecyclerAdapter;
import butterknife.BindView;
import butterknife.ButterKnife;
import fr.arnaudguyon.tabstacker.TabStacker;

public class TopCheckinsFragment extends android.support.v4.app.Fragment implements TabStacker.TabStackInterface {


    @BindView(R.id.feedFragmentRecyclerView)
    RecyclerView recyclerView;

    TopCheckinRecyclerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.top_fragment_checkins, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new TopCheckinRecyclerAdapter(postList, profiles);
    ...
    private void loadFeed(int offset) {
        ...
        ApiFactory.getApi().getTopCheckin(SharedManager.getProperty(Constants.KEY_ACCESS_TOKEN), "1", offset, "photo_130", "top").enqueue(new retrofit2.Callback<ResponseContainer<ResponseWall>>() {
            @Override
