...
public class UsersInPlaceListFragment extends Fragment {
    ...
    public static UsersInPlaceListFragment createInstance(String name, String groupId) {
        UsersInPlaceListFragment fragment = new UsersInPlaceListFragment();
    ...
    private void getFriendsList(){
        ...
        if(mayRestore){
            ...
            ApiFactory.getApi().getUsersInPlace(SharedManager.getProperty(Constants.KEY_ACCESS_TOKEN), getArguments().getString("id"),"photo_780", "0").enqueue(new retrofit2.Callback<ResponseContainer<UsersContainer>>() {
                @Override
