...
public class OnlyCheckinFragment extends android.support.v4.app.Fragment implements TabStacker.TabStackInterface {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.only_checkin_fragment, container, false);
        ButterKnife.bind(this, view);
        return view;
    }

    public static OnlyCheckinFragment createInstance(String name) {
        OnlyCheckinFragment fragment = new OnlyCheckinFragment();
