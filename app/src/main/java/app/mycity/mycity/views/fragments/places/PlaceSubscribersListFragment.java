...
public class PlaceSubscribersListFragment extends Fragment {
    ...
    public static PlaceSubscribersListFragment createInstance(String name, String groupId) {
        PlaceSubscribersListFragment fragment = new PlaceSubscribersListFragment();
    ...
    private void getFriendsList(){
        ...
        if(mayRestore){
            ...
            ApiFactory.getApi().getPlaceSubscribers(SharedManager.getProperty(Constants.KEY_ACCESS_TOKEN), getArguments().getString("id"),"photo_780", "0").enqueue(new retrofit2.Callback<ResponseContainer<UsersContainer>>() {
                @Override
