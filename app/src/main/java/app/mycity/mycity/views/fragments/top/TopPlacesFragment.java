...
public class TopPlacesFragment extends Fragment implements TabStacker.TabStackInterface {
    ...
    private void loadPlaces(int offset, String search) {
        ApiFactory.getApi().getPlaces(SharedManager.getProperty(Constants.KEY_ACCESS_TOKEN), offset, 552, 0, "pop", "").enqueue(new retrofit2.Callback<ResponseContainer<ResponsePlaces>>() {
            @Override
