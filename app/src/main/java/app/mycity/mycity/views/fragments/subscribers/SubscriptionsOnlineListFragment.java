...
public class SubscriptionsOnlineListFragment extends Fragment {
    ...
    public static SubscriptionsOnlineListFragment createInstance(String name, String userId) {
        SubscriptionsOnlineListFragment fragment = new SubscriptionsOnlineListFragment();
    ...
    private void getFriendsList(){
        ...
        if(mayRestore){
            ...
            ApiFactory.getApi().getSubscriptions(SharedManager.getProperty(Constants.KEY_ACCESS_TOKEN), getArguments().getString("userId"), 1 , "photo_780").enqueue(new retrofit2.Callback<ResponseContainer<UsersContainer>>() {
                @Override
