...
public class SubscriptionsOnlineListFragment extends Fragment {
    ...
    private void getFriendsList(){
        ...
        if(mayRestore){
            ...
            ApiFactory.getApi().getSubscriptions(SharedManager.getProperty(Constants.KEY_ACCESS_TOKEN), getArguments().getString("id"), 1 , "photo_780").enqueue(new retrofit2.Callback<ResponseContainer<UsersContainer>>() {
                @Override
