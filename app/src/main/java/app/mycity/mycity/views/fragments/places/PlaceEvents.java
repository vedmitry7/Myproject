...
public class PlaceEvents extends android.support.v4.app.Fragment implements TabStacker.TabStackInterface {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new PlacesEventRecyclerAdapter(postList);
    ...
    private void loadFeed(int offset) {
        ...
        ApiFactory.getApi().getEvents(SharedManager.getProperty(Constants.KEY_ACCESS_TOKEN), "2").enqueue(new retrofit2.Callback<ResponseContainer<ResponseWall>>() {
            @Override
