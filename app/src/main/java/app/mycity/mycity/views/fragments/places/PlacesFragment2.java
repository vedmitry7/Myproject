...
public class PlacesFragment2 extends Fragment implements TabStacker.TabStackInterface {
...
*/
    ...
    public static PlacesFragment2 createInstance(String name) {
        PlacesFragment2 fragment = new PlacesFragment2();
...
/*        String[] sortStrings = {"Рейтинг", "Колличество людей", "Колличество чекинов"};
    ...
    private void loadPlaces(final int offset, int category, String search, String order) {
        ApiFactory.getApi().getPlaces(App.accessToken(), offset, App.chosenCity(), category, order, search, 1).enqueue(new Callback<ResponseContainer<ResponsePlaces>>() {
            @Override
