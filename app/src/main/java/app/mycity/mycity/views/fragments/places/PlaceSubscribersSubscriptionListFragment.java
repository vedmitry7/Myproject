...
public class PlaceSubscribersSubscriptionListFragment extends Fragment {
    ...
    public static PlaceSubscribersSubscriptionListFragment createInstance(String name, String groupId) {
        PlaceSubscribersSubscriptionListFragment fragment = new PlaceSubscribersSubscriptionListFragment();
    ...
    private void getFriendsList(){
        ...
        if(mayRestore){
            ...
            ApiFactory.getApi().getPlaceSubscribers(SharedManager.getProperty(Constants.KEY_ACCESS_TOKEN), getArguments().getString("id"),"photo_780", "1").enqueue(new retrofit2.Callback<ResponseContainer<UsersContainer>>() {
                @Override
