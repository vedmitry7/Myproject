...
public class FeedPlacesCheckinFragmentNew extends android.support.v4.app.Fragment implements TabStacker.TabStackInterface {
    ...
    public static FeedPlacesCheckinFragmentNew createInstance(String name, int tabPos, String placeId) {
        FeedPlacesCheckinFragmentNew fragment = new FeedPlacesCheckinFragmentNew();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.feed_fragment_places_checkin_new, container, false);
