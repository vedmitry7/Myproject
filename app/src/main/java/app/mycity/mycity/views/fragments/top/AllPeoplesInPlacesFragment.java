...
public class AllPeoplesInPlacesFragment extends Fragment {
    ...
    private void getFriendsList(){
        ...
        ApiFactory.getApi().getTopUsersInPlaces(SharedManager.getProperty(Constants.KEY_ACCESS_TOKEN), "photo_780,place,count_likes", "top", "in_place").enqueue(new retrofit2.Callback<ResponseContainer<UsersContainer>>() {
            @Override
