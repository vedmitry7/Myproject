...
public class FeedPhotoReportFragmentContent2 extends android.support.v4.app.Fragment implements TabStacker.TabStackInterface {
  ...
  //  EventBusMessages.OpenPlacePhoto2 event;
    ...
    public static FeedPhotoReportFragmentContent2 createInstance(String name, int tabPos, String placeId, String albumId, String albumName, Long albumDate, int position) {
        FeedPhotoReportFragmentContent2 fragment = new FeedPhotoReportFragmentContent2();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.feed_photo_report_content2, container, false);
